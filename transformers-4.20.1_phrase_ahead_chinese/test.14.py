...
#    print(prefix_ids)
    with torch.no_grad():
        ...
        pred_ids= model.generate(input_ids_no_mask.cuda(), num_beams=34, max_length=mask_index[0]+4+2+1000,num_return_sequences=10,prefix_ids=prefix_ids,mask_pos=range(len(prefix_ids)+1,attn_len),drop_rate=0.5)
