...
#all dict
bart_results=open("results/wiki/sort.number/bart.ahead/wiki.out.embed.0.1.oot").readlines()
bert_results=open("results/wiki/sort.number/bert/wiki.out.embed.0.1.oot").readlines()
dict_results=open("results/wiki/sort.number/dict/wiki.out.embed.0.1.oot").readlines()
embed_results=open("results/wiki/sort.number/embed/wiki.out.embed.0.1.oot").readlines()
...
#all_results=open("all.sorted.200.txt").readlines()
f6_1=open("results/wiki/sort.number/wiki.out.embed.0.1_p1.txt","w+")
f6_2=open("results/wiki/sort.number/wiki.out.embed.0.1_p3.txt","w+")
f6_3=open("results/wiki/sort.number/wiki.out.embed.0.1_probabilites.txt","w+")
f6_4=open("results/wiki/sort.number/wiki.out.embed.0.1.best","w+")
f6_5=open("results/wiki/sort.number/wiki.out.embed.0.1.oot","w+")
...
for i in tqdm(range(len(bart_results))):
    ...
    #cands=list(set(dict_words_max10).union(set(embed_words_max10)))
    all_indexs=[]
    count=0
    for cand in cands:
        if cand==source_word:
...
work_dir="results/wiki/sort.number/"
output_SR_file="wiki.out"
output_score_file="wiki.out.scores"
embed_quto="0.1"


evaluation_metric = evaluation()
test_golden_file="dataset/Chinese_LS/wiki_test_gold.txt"
