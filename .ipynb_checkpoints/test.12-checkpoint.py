...
for line in open("dataset/chinese_ls/annotation_data.csv").readlines():
...
#    print(input_ids)
#    print(prefix_ids)
    pred_ids= model.generate(input_ids.cuda(), num_beams=17, max_length=mask_index[0]+4+2+1000,num_return_sequences=17,prefix_ids=prefix_ids)
