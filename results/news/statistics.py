...
# dict_output=open("dict/news.out.embed.0.1.oot").readlines()
# dict_output=open("embed/news.out.embed.0.1.oot").readlines()
# dict_output=open("bert/news.out.embed.0.1.oot").readlines()
# dict_output=open("sort.bart.ahead/news.out.embed.0.1.oot").readlines()
dict_output=open("sort.number/all/news.out.embed.0.1.oot").readlines()
...
labels_dict={}
for line in open("/home/yz/liukang/liukang/PhraseSimplification/dataset/Chinese_LS/news_test_gold.txt"):
