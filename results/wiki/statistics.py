...
#dict_output=open("dict/wiki.out.embed.0.1.oot").readlines()
# dict_output=open("embed/wiki.out.embed.0.1.oot").readlines()
# dict_output=open("bert/wiki.out.embed.0.1.oot").readlines()
# dict_output=open("sort.bart.ahead/wiki.out.embed.0.1.oot").readlines()
dict_output=open("sort.number/all/wiki.out.embed.0.1.oot").readlines()
...
labels_dict={}
for line in open("/home/yz/liukang/liukang/PhraseSimplification/dataset/Chinese_LS/wiki_test_gold.txt"):
